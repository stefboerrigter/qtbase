...
#if 0               /* disable double and triple length */
...
extern void vnc_deskey(unsigned char *, short);
/*		      hexkey[8]     MODE
...
extern void vnc_usekey(unsigned long *);
/*		    cookedkey[32]
 * Loads the internal key register with the data in cookedkey.
 */
 
extern void vnc_cpkey(unsigned long *);
/*		   cookedkey[32]
 * Copies the contents of the internal key register into the storage
 * located at &cookedkey[0].
 */
 
extern void vnc_des(unsigned char *, unsigned char *);
/*		    from[8]	      to[8]
